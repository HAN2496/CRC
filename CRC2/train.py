...
#Visualize
n_samples = 9
visualize_predictions_scalar(reg, X_test, y_test, n_samples=n_samples, input_window_length=INPUT_WINDOW_LENGTH, file_name=MODEL_NAME)
visualize_predictions_polar(reg, X_test, y_test, n_samples=n_samples, input_window_length=INPUT_WINDOW_LENGTH, file_name=MODEL_NAME)

"""
Step2:  Fit reference trajectory (by gaussian process)
"""
td = TD(number=6, choose_one_dataset=True, extract_walking=True)
